...
describe("Form Validation <App />", () => {
  ...
  it("check entire form validation when the form is valid", () => {
    ...
    form
      .find(".email")
      .simulate("change", { target: { value: "aasdbc@xyz.com" } });
    form.find(".phone").simulate("change", { target: { value: "9856756756" } });
    form
      .find(".address")
      .simulate("change", { target: { value: "http://google.com" } });
    form.find(".button").simulate("click");
    expect(form.state().isFormValid).toEqual(true);
  });
  ...
  it("check entire form validation when the phone number is invalid", () => {
    ...
    form
      .find(".email")
      .simulate("change", { target: { value: "abc@xyz.com" } });
    form.find(".phone").simulate("change", { target: { value: "56756756" } });
    form
      .find(".address")
      .simulate("change", { target: { value: "http://google.com" } });
    form.find(".button").simulate("click");
    expect(form.state().isFormValid).toEqual(false);
  });
  ...
  it("check entire form validation when the url is invalid", () => {
    ...
    form
      ...
      .simulate("change", { target: { value: "abc@xyz.com" } });
    form.find(".phone").simulate("change", { target: { value: "56756756" } });
    form.find(".address").simulate("change", { target: { value: "ht" } });
    form.find(".button").simulate("click");
    expect(form.state().isFormValid).toEqual(false);
  });
  ...
  it("check form validation when the entire form is invalid", () => {
    ...
    form.find(".address").simulate("change", { target: { value: "h9" } });
    form.find(".button").simulate("click");
    expect(form.state().isFormValid).toEqual(false);
  });
});
